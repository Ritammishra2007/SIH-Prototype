...
export default function AdminLoginPage() {
  ...
  return (
    <PhoneShell
      badge="Admin"
      headerTitle="Regulator Oversight"
      headerSubtitle="Central Pollution Control Board (CPCB) Console"
      showBack
      onBack={() => router.push("/")}
    >
      <div className="flex flex-col justify-between flex-1 py-1 bg-white">
        <div>
          <div className="text-center py-3">
            ...
            <p className="text-xs text-slate-500 mt-1">
              National e-waste formalization registry &amp; price surveillance
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="p-3 rounded-xl bg-blue-50 border border-blue-200 text-center space-y-1.5">
              <p className="text-xs text-blue-800 font-medium">
                Demo login: admin@demo.com / admin1234
              </p>
              <button
                type="button"
        ...
        <div className="text-center pt-4 border-t border-slate-100 mt-6">
          <p className="text-[11px] text-slate-400 flex items-center justify-center gap-1">
            ...
            <span>Regulator Surveillance Console • Restricted Access</span>
          </p>
        </div>
      </div>
    </PhoneShell>
